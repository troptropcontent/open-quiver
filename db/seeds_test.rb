...
require 'nokogiri'
 ...
 url = "https://www.akewatu.fr/surf/planches-de-surf?topProduct=0&pricerange=119%3B2000&zone%5B%5D=1&page=5"
 ...
 cards.each do |card| 
  ...
  if title.count == 1 && spec.count == 1
    ...
    puts "width: #{spec.search('span')[1].text.strip}"
    puts "thickness: #{spec.search('span')[2].text.strip}"
